function V = Movement_v2(fname,seg_times,frame_interval,save_flag,smoothing_factors,oldparam,varargin)
% With resize
...
% V=Movement({'video1.wmv','video2.wmv','video3.wmv'});
%
...
for i=1:numfiles
    ...
    if isempty(seg_times_og)
        seg_times(i,:) = [0 vidObj{i}.Duration-frame_interval(i)];
     elseif size(seg_times_og,1)<numfiles && i>1
